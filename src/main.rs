...
fn count_characters(string_holder: & mut str) -> usize {
	string_holder.len()
}

fn count_words(string_holder: & mut str) -> usize {
	string_holder.split_whitespace().collect::<Vec<_>>().len()
}

fn count_lines(string_holder: & mut str) -> usize {
	string_holder.split('\n').collect::<Vec<_>>().len()
}
...
fn main() {
	...
	let chars_len = count_characters(& mut string_holder);
	let words_count = count_words(& mut string_holder);
	let lines_count = count_lines(& mut string_holder);
